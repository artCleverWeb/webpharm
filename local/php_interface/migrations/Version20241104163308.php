...
class Version20241104163308 extends Version
{
    protected $author = "admin";

    protected $description = "Изменение в настройках ИБ Ответов на тесты";
  ...
  'API_CODE' => 'corporateTestsResults',
  'REST_ON' => 'N',
  'NAME' => 'Корпоративное обучение: Ответы тестов',
  'ACTIVE' => 'Y',
  'SORT' => '500',
