...
$isAjax  = false;
if ($request->isAjaxRequest() && $request->get("AJAX_PAGE") == "Y")
{
    $isAjax = true;
...
{
    $arParams["FILTER_NAME"] = "arFilterJournalPromo";
}
$GLOBALS[$arParams["FILTER_NAME"]] = [];
$arPromo = $APPLICATION->IncludeComponent(
    "bitrix:news.index",
    ".default",
    [
...
if (!empty($arPromo["ID"]))
{
    $GLOBALS[$arParams["FILTER_NAME"]]["!=ID"] = $arPromo["ID"];
}
if ($isAjax)
{
    $APPLICATION->RestartBuffer();
