        ...
        <div class="navbar__data">
            ...
            <a href="#" class="user-mini user-mini_navbar navbar__user">
                <div class="user-mini__picture">
                    <img src="/assets/upload//assets/images/1-1.png" alt="" class="user-mini__picture-img">
                </div>
            ...
            <nav class="menu-main navbar__menu-main">
                <div class="menu-main__list">
                    <div class="menu-main__item active">
                        <a href="#" class="menu-main__item-link">
                            <div class="menu-main__item-link-icon">
                                <svg class="icon menu-main__item-link-icon-canvas"><use xlink:href="/assets/images/icons/icons.svg#icon-study"></use></svg>
                            </div>
                    ...
                    <div class="menu-main__item">
                        <a href="#" class="menu-main__item-link">
                            <div class="menu-main__item-link-icon">
                                <svg class="icon menu-main__item-link-icon-canvas"><use xlink:href="/assets/images/icons/icons.svg#icon-smile"></use></svg>
                            </div>
                            <div class="menu-main__item-link-text">
                                Мы заботимся о вас
                            </div>
                    ...
                    <div class="menu-main__item">
                        <a href="#" class="menu-main__item-link">
                            <div class="menu-main__item-link-icon">
                                <svg class="icon menu-main__item-link-icon-canvas"><use xlink:href="/assets/images/icons/icons.svg#icon-calendar"></use></svg>
                            </div>
                            <div class="menu-main__item-link-text">
                                События
                            </div>
                    ...
                    <div class="menu-main__item">
                        <a href="#" class="menu-main__item-link">
                            <div class="menu-main__item-link-icon">
                                <svg class="icon menu-main__item-link-icon-canvas"><use xlink:href="/assets/images/icons/icons.svg#icon-journal"></use></svg>
                            </div>
                            <div class="menu-main__item-link-text">
                                Журнал
                            </div>
                    ...
                    <div class="menu-main__item">
                        <a href="#" class="menu-main__item-link">
                            <div class="menu-main__item-link-icon">
                                <svg class="icon menu-main__item-link-icon-canvas"><use xlink:href="/assets/images/icons/icons.svg#icon-ruble"></use></svg>
                            </div>
                            <div class="menu-main__item-link-text">
                                Заработать больше
                            </div>
                    ...
                    <div class="menu-main__item">
                        <a href="#" class="menu-main__item-link">
                            <div class="menu-main__item-link-icon">
                                <svg class="icon menu-main__item-link-icon-canvas"><use xlink:href="/assets/images/icons/icons.svg#icon-ruble-x"></use></svg>
                            </div>
                            <div class="menu-main__item-link-text">
            ...
            <div class="navbar__footer">
                <label class="input-button-a navbar__option">
                    <input type="checkbox" class="input-button-a__input" checked disabled />
