...
<div class="grid__item grid__item_1">
    <div class="authorization js-authorization">
        <form action="<?=$APPLICATION->GetCurPageParam("login=yes", ["login","forgot_password","mobile"])?>" class="form authorization__form" name="form_auth" method="post">
            ...
            <div class="form__fields">
                <div class="form__item"> <!-- form__item invalid -->
                    ...
                    <div class="field-form form__field-form">
                        <input type="text" class="input-text field-form__input-text" name="USER_LOGIN" value="<?=$loginStr?>" placeholder="+7 (9 -- ) --- -- -- " data-mask="+7 (000) 000-00-00" />
                    </div>
                ...
                <div class="form__item">
                    ...
                    <div class="field-form form__field-form">
                        <input type="password" name="USER_PASSWORD" class="input-text field-form__input-text" placeholder="***********" />
                    </div>
                    <div class="form__info form__info_error">
                        Поле заполнено неверно
                    </div>
                ...
                <div class="form__item form__item_submit">
                    <label class="input-button">
                        <input type="checkbox" class="input-button__input" name="USER_REMEMBER" value="Y" checked />
    ...
    <div class="menu-a">
        <div class="menu-a__list">
            <div class="menu-a__item">
                <a href="<?=$APPLICATION->GetCurPageParam("forgot_password=yes", ["login","forgot_password"])?>" class="link link_type-1 link_color-1 menu-a__item-link">
                    Восстановить пароль
                </a>
            </div>
<!--            <div class="menu-a__item">-->
